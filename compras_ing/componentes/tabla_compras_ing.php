...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Compras Ingredientes</title>
...
<!--        <link rel='stylesheet' type='text/css' href='../lib/glyphicon.css'>
    ...
    <body class="body">
        <div class="containerExt classext">
            <div class="row">
                <div class="col-sm-12">
                    <h2 align="center" class="h2PDC">COMPRAS DE INGREDIENTES</h2>
                    ...
                    <table class="table myhover table-condensed table-bordered" id="tablaDinamicaLoad" style="width:100%">
                        ...
                        <tbody>
                            ...
                            //PDO o Mysqli son objetos de conexion
                                ...
                                $query = "SELECT compras_ingredientes.*, ingredientes.nombre AS ingrediente FROM compras_ingredientes INNER JOIN ingredientes 
                                WHERE compras_ingredientes.ingredientes_id = ingredientes.Id";
                                    ...
                                    //No se porque el array $datos NO PUEDE SER ENVIADO EN EL PHP DE ARRIBA, DONDE "Agrego nuevo" 
                                            ...
                                            ?>
                                                ...
                                                <tr class="classColor">
                                                    ...
                                                    <td><?php echo $array['ingrediente']; ?></td>
