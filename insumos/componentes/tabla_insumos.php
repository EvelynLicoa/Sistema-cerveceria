...
<!--        <link rel='stylesheet' type='text/css' href='../lib/glyphicon.css'>
    ...
    <body class="body">
        <div class="containerExt classext">
            <div class="row">
                <div class="col-sm-12">
                    <h2 align="center" class="h2PDC">INSUMOS</h2>
                    ...
                    <table class="table myhover table-condensed table-bordered" id="tablaDinamicaLoad" style="width:100%">
                        ...
                        <tbody>
                            ...
                            //PDO o Mysqli son objetos de conexion
                                ...
                                $query = "SELECT insumos.*, proveedores.nombre AS proveedor FROM insumos INNER JOIN proveedores 
                                WHERE insumos.proveedores_id = proveedores.Id ORDER BY insumos.nombre";
