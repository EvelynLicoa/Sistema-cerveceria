...
<html>
    <head>
        ...
        <script src="../insumos/js_insumos/funciones.js"></script>
    ...
    <header>
        <div id="header">
            <ul class="nav navbar-nav">
                <li><a class="btn btn-primary btn-lg" href="../index.php">Regresar</a></li>
            </ul>
        </div>  
    </header>
    ...
    <body class="mainBody">
        ...
        <div class="modal fade" id="modalNuevo" tabindex="-1" role="dialog" aria-labelledby="myModalLabelUno">
            <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                    <div class="modal-header fondoNegro">
                        ...
                        <h4 class="modal-title" id="myModalLabelUno">REGISTRO DE INSUMOS</h4>
                    </div>
                    ...
                    <div class="modal-body fondoGris">    
                        ...
                        <div  class="form-group">
                            ...
                            <input type="text" id="recordatorio" name="recordatorio" class="form-control input-sm">
                        </div>
    ...
    <form class="formModal"> 
         <div class="modal fade" id="modalEdicion" tabindex="-1" role="dialog" aria-labelledby="myModalLabelDos">
            <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                    <div class="modal-header fondoNegro">
                        <button type="button" class="close" id="closeform" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabelDos">EDITAR DATOS</h4>
                    </div>
                 <div class="modal-body fondoGris">    
                        <div  class="form-group" hidden>
                            <label>ID</label>
                       ...
                       <div  class="form-group">
                        ...
                        <div  class="form-group">
                         ...
                         <div  class="form-group">
                            <label>COSTO</label>
                            <input type="text" id="costou" name="costou" class="form-control input-sm">
                        </div>
                        ...
                        <div  class="form-group">
                            <label>RECORDATORIO</label>
                            <input type="text" id="recordatoriou" name="recordatoriou" class="form-control input-sm">
                        </div>
